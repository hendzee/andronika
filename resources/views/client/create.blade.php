                        ...
                        <form action="{{ action('ClientController@store') }}" method="POST" class="form-horizontal form-row-seperated">
                            <div class="form-body">
                                <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        <input name="description" value="{{ old('description') }}" type="text" placeholder="Nama Klien" class="form-control" />
                                ...
                                <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{ old('address') }}" name="address" placeholder="Alamat" class="form-control" />
                                ...
                                <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        <input name="email" value="{{ old('email') }}" type="text" placeholder="Email" class="form-control" />
