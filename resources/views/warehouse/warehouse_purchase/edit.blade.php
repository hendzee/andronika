            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">                    
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form action="{{ action('WarehousePurchaseController@update', $data_purchase->id_purchase) }}" method="POST" class="form-horizontal form-row-seperated">
                            <div class="form-body">                                                                
                                <div class="form-group">
                                    <label class="control-label col-md-3">Nama Barang</label>
                                    <div class="col-md-9">
                                        <select name="item_name" class="form-control">
                                            <option value="{{$data_purchase->item_name}}">
                                                {{ $data_purchase->item_name . ' (DATA SAAT INI)' }}
                                            </option> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{ $data_purchase->number }}" name="number" placeholder="Jumlah Barang" class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{ $data_purchase->price_per_item }}" name="price_per_item" placeholder="Harga Barang / Satuan" class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{ $data_purchase->resp_person }}"  name="resp_person" placeholder="Pembeli" class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{ $data_purchase->token }}" name="token" placeholder="Bukti Transaksi" class="form-control" />
                                        <span class="help-block"> Harga Barang / Satuan </span>
                                    </div>
                                </div>                                                                                                                                                                           
                            </div>
