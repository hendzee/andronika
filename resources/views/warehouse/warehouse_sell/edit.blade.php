                        ...
                        <form action="{{ route('warehouse_sell.update', $data_sell->id_sell) }}" method="POST" class="form-horizontal form-row-seperated">
                            <div class="form-body">                                                                
                                ...
                                <div class="form-group {{ $errors->has('number') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{ old('number', $data_sell->number) }}" name="number" placeholder="Jumlah Barang" class="form-control" />
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-inline">
                                            <div class="input-group">
                                                ...
                                                <input type="text" value="{{ old('price_per_item', round($data_sell->price_per_item)) }}" id="total" placeholder="Harga Per Satuan" class="form-control masking-form" />
                                ...
                                <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        <input name="date" value="{{ old('date', date('m/d/Y', strtotime($data_sell->date))) }}" class="form-control form-control-inline input-medium date-picker" size="16" type="text" value="" />
                                ...
                                <div class="form-group {{ $errors->has('resp_person') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{ old('resp_person', $data_sell->resp_person) }}" name="resp_person" placeholder="Penanggung Jawab" class="form-control" />
