                        ...
                        <form action="{{ action('CompanyCashController@update', $data_cash->id_transaction) }}" method="POST" class="form-horizontal form-row-seperated">
                            <div class="form-body">
                                ...
                                <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-9">
                                        <input name="date" value="{{ old('date', date('d-m-Y', strtotime($data_cash->date))) }}" class="form-control form-control-inline input-medium date-picker" size="16" type="text" value="" />
