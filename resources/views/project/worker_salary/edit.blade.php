    ...
    <div class="page-content" style="min-height: 1540px;">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                <li>
                    <a href="{{ route('project.show', $data_salary->id_project) }}"> Menu </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <a href="{{ route('worker_salary_index', $data_salary->id_project) }}"> Gaji Harian </a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span>Edit</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ number_format($data_salary->salary) }}" placeholder="Jumlah Gaji" class="form-control masking-form" />
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{ route('worker_salary_index', $data_salary->id_project) }}" class="btn default"> 
                                            Batal
                                        </a>
                                    </div>
                                </div>
